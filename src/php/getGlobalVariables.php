...
if ($result->num_rows > 0) {
    ...
    $arr = array("id_User" => $id_User, "id_Placa" => $id_Placa, "id_Sonda" => $id_Sonda, "id_Receta" => $_SESSION['id_Receta'], "paso_Actual" => $_SESSION['paso_Actual'], "id_Paso_Receta_Actual" => $_SESSION['id_Paso_Receta_Actual']);
